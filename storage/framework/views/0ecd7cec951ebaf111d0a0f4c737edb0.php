<?php $__env->startSection('title', 'Halaman Penggajian'); ?>

<?php $__env->startSection('content'); ?>

    <?php if(auth()->user()->fhrd == 1): ?>
        <link rel="stylesheet" href="<?php echo e(asset('css/penggajian.css')); ?>?v=1">
        ...
        <?php echo $__env->make('penggajian.components.table_rekening', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('penggajian.modals.modal_tambah_rekening', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('penggajian.modals.modal_edit_rekening', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <?php echo $__env->make('penggajian.components.table_tunjangan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('penggajian.modals.modal_tambah_gaji', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="d-flex justify-content-between align-items-start mb-3">
            ...
            <form id="formDepartmentFilter" method="GET" action="<?php echo e(route('penggajian.index')); ?>"
                class="d-flex align-items-center gap-2" autocomplete="off">
                <input type="hidden" name="year" value="<?php echo e($selYear); ?>">
                <input type="hidden" name="month" value="<?php echo e($selMonth); ?>">

                <select id="departmentFilter" name="department_id" class="form-select" style="width:220px;"
                    autocomplete="off">
                    <option value="" <?php echo e($curDep === '' ? 'selected' : ''); ?>>Semua Departemen</option>
                    <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($dep->nid); ?>" <?php echo e((string) $curDep === (string) $dep->nid ? 'selected' : ''); ?>>
                            <?php echo e($dep->cname); ?>
                ...
                <?php if($curDep !== ''): ?>
                    <a href="<?php echo e(route('penggajian.index', ['year' => $selYear, 'month' => $selMonth])); ?>"
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <form id="formExportExcel" action="<?php echo e(route('gaji.export')); ?>" method="POST" style="display:none;">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="month" value="<?php echo e($selMonth); ?>">
                    <input type="hidden" name="year" value="<?php echo e($selYear); ?>">
                    <input type="hidden" name="selected_ids" id="selected_ids">
                    <input type="hidden" name="source_table" id="source_table" value="<?php echo e($exportSource ?? 'csalary'); ?>">
                    
                    <input type="hidden" name="department_id" id="export_department_id"
                        value="<?php echo e(request('department_id') ?? ''); ?>">
                </form>
        ...
        <?php echo $__env->make('penggajian.components.table_payroll', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('penggajian.modals.modal_hitung', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('penggajian.modals.modal_kirim_slip', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('penggajian.modals.modal_payroll_bank', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('penggajian.modals.modal_edit', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('penggajian.modals.modal_report_gaji', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const selYear = "<?php echo e($selYear); ?>";
                const selMonth = "<?php echo e($selMonth); ?>";
                ...
                deptSelect.addEventListener('change', function() {
                    ...
                    const url = "<?php echo e(route('penggajian.filter.department')); ?>" +
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/matahati/domains/absensi.matahati.my.id/public_html/laravel/resources/views/penggajian/index.blade.php ENDPATH**/ ?>