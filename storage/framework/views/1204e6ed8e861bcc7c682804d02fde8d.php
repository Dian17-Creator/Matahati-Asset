...
<div class="modal fade" id="modalEditPayroll" tabindex="-1" aria-labelledby="modalEditPayrollLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="formEditPayroll" method="POST" data-url="<?php echo e(route('gaji.update', ':id')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <?php echo $__env->make('penggajian.modals.modal_edit_fields', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH /home/matahati/domains/absensi.matahati.my.id/public_html/laravel/resources/views/penggajian/modals/modal_edit.blade.php ENDPATH**/ ?>