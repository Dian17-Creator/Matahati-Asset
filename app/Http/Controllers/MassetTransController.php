            ...
            DB::transaction(function () use ($request) {
                ...
                if ($request->jenis_asset === "QR") {
                    ...
                    $validated = $request->validate([
                        "sub_kategori_id" =>
                            "required|exists:masset_subkat,nid",
                    ...
                    $urut =
                        MassetTrans::where("cjnstrans", "Add")
                            ->whereRaw("DATE_FORMAT(dtrans,'%y%m') = ?", [
                                $periode,
                            ])
                            ->lockForUpdate()
                            ->count() + 1;
                    ...
                    if ($request->hasFile("foto")) {
                        ...
                        $file->move(public_path("assets/trans"), $namaFoto);
                ...
                if ($request->jenis_asset === "NON_QR") {
                    ...
                    $validated = $request->validate([
                        "ckode_asset_nonqr" =>
                            "required|exists:masset_noqr,ckode",
                    ...
                    $nonQr = MassetNoQr::where(
                        "ckode",
                        $validated["ckode_asset_nonqr"],
                    )
                    ...
                    if (!$nonQr) {
                        ...
                        throw new \Exception(
                            "Asset Non QR tidak ditemukan di lokasi tersebut",
                        );
                    }
